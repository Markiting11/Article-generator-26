...
3. Add the `OPENROUTER_API_KEY` in the project settings under "Environment Variables".
4. Deploy!
...
3. Add the `OPENROUTER_API_KEY` in the site settings under "Environment Variables".
4. Deploy!
